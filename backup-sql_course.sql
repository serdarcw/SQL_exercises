...
--
-- Host: call-mysql-db-server.cbanmzptkrzf.us-east-1.rds.amazonaws.com    Database: sql_course
-- ------------------------------------------------------
...
CREATE TABLE `dependents` (
  ...
  `relationship` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2020-07-09  0:53:00
